  ...
  return (
    <div className="flex flex-col items-center">
      <button
        ...
        className="flex cursor-pointer items-center gap-2 rounded-full border border-misty px-6 py-3 text-base font-semibold text-white hover:bg-misty hover:text-noir"
      >
        {isPlaying ? (
          <>
            <Pause />
